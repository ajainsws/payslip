...
<nav id="left-nav" class="left-nav-bar">
    ...
    <div class="nav-bottom-sec">
        <ul class="left-navigation" id="left-navigation">
            ...
            {{--Payroll--}}
            <li @if(Request::path()== 'employee/payslip'  OR Request::path()=='employee/payslip/view/'.view_id()) class="active" @endif><a href="{{url('employee/payslip')}}"><span class="menu-text">{{language_data('Payslip')}}</span> <span class="menu-thumb"><i class="fa fa-inr"></i></span></a></li>
            @endif
