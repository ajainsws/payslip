                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" name="gender">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name="pre_address">{{$employee->pre_address}}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label>{{language_data('Permanent Address')}}</label>
                                            <textarea class="form-control" rows="4" name="per_address">{{$employee->per_address}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>PF Account / UAN</label>
                                            <input type="text" class="form-control" name="pf_uan" value="{{$employee->pf_uan}}">
                                        </div>
